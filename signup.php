<?php
	...
	if (isset($_POST['user_name'])) 
	{
		...
		{
			$error=0;
			$first_name_message='The First Name Field accepts only the character.';	
		}
		...
		{
			$error=0;
			$last_name_message='The Last Name Field accepts only the characters.';	
		}
		...
		{
			$error=0;
			$password_message='Length Should be 5-9 Characters.';	
		}
		...
		{
			$error=0;
			$contact_number_message='The Contact Number Field only accepts numbers .';	
		}
		else if(strlen($contact_number)!=10)
		{
			$error=0;
			$contact_number_message='Length must be 10 digits.';	
		}
		else
		{
		...
		{
			$error=0;
			$location_message='Max-Length Upto 20 Characters Only.';	
		}
		if($error==1)
		{
